...
const catalog: CourseCatalogItem[] = [
  {
    ...
    tags: ['Solidity', 'Mezo', 'Tooling'],
    summary:
      'Hands-on introduction to Solidity, Hardhat, and secure smart-contract patterns for Mezo builders.'
  },
  {
    courseId: 2n,
    ...
    summary:
      'Blueprint and templates for crafting recurring-revenue membership products with CreatorBank infrastructure on Mezo.'
  },
  {
    courseId: 3n,
